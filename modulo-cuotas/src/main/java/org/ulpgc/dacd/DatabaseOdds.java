...
public class DatabaseOdds implements OddsSerializer {
    ...
    public DatabaseOdds() {
        ...
        try (Connection connection = connect()) {
            ...
            throw new RuntimeException("Error initializing odds database", e);
        }
    }

    @Override
    public void serialize(Odd odd) {
        String sql = """
        ...
        try (Connection connection = connect();
            ...
            System.err.println("Error saving odd: " + e.getMessage());
        }
    }

    // Métodos de consulta — fuera del contrato OddsSerializer.
    // En sprints posteriores se moverán a una interfaz OddsRepository.
    ...
    private void createOddsTable(Connection connection) throws SQLException {
        String sql = """
